...
namespace Faraboom.Framework.Startup
{
        ...
        where TRole : class
    {
        ...
        private IMvcBuilder ConfigureServicesInternal(IServiceCollection services, string dir, string applicationName)
        {
            ...
            {
                options.DataAnnotationLocalizerProvider = (type, factory) => factory.Create(typeof(Resources.GlobalResource));
            });
            ...
            var embeddedFileProvider = new EmbeddedFileProvider(Assembly.GetCallingAssembly(), "Faraboom.Framework");
        ...
        private void AddScopedDynamic(IServiceCollection services, Assembly frameworkAssembly, IEnumerable<string> assemblyFiles)
        {
            ...
            var injectableTypes = allTypes.Where(t => t.GetCustomAttribute<InjectableAttribute>() != null);
