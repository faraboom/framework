...
namespace Faraboom.Framework.UI.FormBuilder
{
    ...
    public static class DisplayNameExtension
    {
        ...
        public static List<Func<Type, object, bool, string>> Rules = new List<Func<Type, object, bool, string>>()
        {
            ...
            (type, o, tc) => o is IHasDisplayName name ? name.DisplayName : null,
            (type, o, tc) => o is IHasName name ? name.Name.Sentencise(tc): null,
            (type, o, tc) => o is Enum ? GetNameFromEnum(o): null,
            (type, o, tc) => o is Type type1 ? type1.Name.Sentencise(tc): null,
